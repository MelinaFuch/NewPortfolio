...
const projects = [
  ...
  {
    name: "API StarWars",
    subtitle: "Proyecto de curso de Docker",
    rol: "Creación y gestión de Base de Datos y rutas | Microservicios | Deploy en máquina virtual",
  ...
  },
  {
    ...
    rol: "Estructura con HTML | Estilizado con CSS | Integración de animaciones CSS y JavaScript",
